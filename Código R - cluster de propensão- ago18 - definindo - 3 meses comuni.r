# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
#                                                                   #
#             Job: Novo modelo CredLeader 2018 - 3meses             #
...
# Retirando cluster 0
  ...
  ago18_3m_cluster_semzero<-ago18_3m_cluster[-1,]
  head(ago18_3m_cluster_semzero)
    # MALA_SMS_EMAIL_16m  conversao
    # 2                  1 0.01489875
    # 3                  2 0.01779447
    # 4                  3 0.01979278
...
# - # - # - # - #
    # v11: -  conversão e sem zero e 3 meses de retorno
      set.seed(100)
      ago18_cluster_feito_sem_zero_11<-kmeans(ago18_3m_cluster_semzero[,2],
                                              4,
                                              1000, nstart = 1)
      ago18_cluster_feito_sem_zero_11$centers
      ago18_cluster_feito_sem_zero_11$size
      
      # Preparando cluster sem zero para salvar:
      ago18_cluster_feito_sem_zero_salvar <- cbind(ago18_3m_agg[-1,], 
                                                   cluster_sem0 = ago18_cluster_feito_sem_zero_11$cluster,
                                                   qtd_comunis=rep(1,nrow(ago18_3m_agg)-1))
      
      # Salvando:
      setwd('C:/Users/phohberg/Desktop/Jobs/Jobs/AÇÕES/CREDLeader/Modelo/Novo modelo/Ago18/Cluster')
      write.csv2(ago18_cluster_feito_sem_zero_salvar,
                 file='Clusters comuni ago18 clusterizado sem 0 para modelagem -v11.csv',
                 row.names = F) 
  
# - # - # - # - #
    # v12: -  conversão e com zero e 3 meses de retorno
      set.seed(100)
      ago18_cluster_feito_com_zero_12<-kmeans(ago18_3m_cluster[,2],
                                              4,
                                              1000, nstart = 1)
      ago18_cluster_feito_com_zero_12$centers
      ago18_cluster_feito_com_zero_12$size
      
      # Preparando cluster sem zero para salvar:
      ago18_cluster_feito_sem_zero_salvar <- cbind(ago18_3m_agg, 
                                                   cluster_ = ago18_cluster_feito_com_zero_12$cluster,
                                                   qtd_comunis=rep(1,nrow(ago18_3m_agg)))
      
      # Salvando:
      setwd('C:/Users/phohberg/Desktop/Jobs/Jobs/AÇÕES/CREDLeader/Modelo/Novo modelo/Ago18/Cluster')
      write.csv2(ago18_cluster_feito_sem_zero_salvar,
                 file='Clusters comuni ago18 clusterizado com 0 para modelagem -v12.csv',
                 row.names = F)  
